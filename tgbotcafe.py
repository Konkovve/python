...
def main():
    ...
    app.add_handler(CommandHandler("menu", cafe_bot.menu))
    app.add_handler(CommandHandler("add", cafe_bot.add))
    app.add_handler(CommandHandler("order", cafe_bot.order))
    app.add_handler(CommandHandler("clear", cafe_bot.clear))
    app.add_handler(CommandHandler("checkout", cafe_bot.checkout))
    app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, cafe_bot.add_item))
